...
public class Activity09_BulkUpdateDeleteLibros {
    public static void main(String[] args) {
        ...
        try {
            ...
            jakarta.persistence.Query updateQuery = entityManager.createQuery("UPDATE Libro l SET l.activo = FALSE WHERE l.stock = 0");
            int updatedCount = updateQuery.executeUpdate();
            System.out.println("Libros actualizados (activo = FALSE): " + updatedCount);

            // TODO: DELETE FROM Libro l WHERE l.precio < 100
            jakarta.persistence.Query deleteQuery = entityManager.createQuery("DELETE FROM Libro l WHERE l.precio < 100");
